...
contract BaseRefinanceTest is TestUtils, StateManipulations {
        ...
        internal 
    {
        ...
        loan.fundLoan(address(this), principalRequested_);
    ...
    function _encodeWithSignatureAndUint(string memory  signature_, uint256 arg_) internal returns (bytes[] memory calls) {
        calls = new bytes[](1);
...
contract RefinancerEndingPrincipalTest is BaseRefinanceTest {
        ...
        external 
    {
        ...
        setUpOngoingLoan(principalRequested_, collateralRequired_, principalRequested_, gracePeriod_,  interestRate_, lateFeeRate_, paymentInterval_, paymentsRemaining_);
        ...
        loan.acceptNewTerms(address(refinancer),  data);
        ...
        external 
    {
        ...
        setUpOngoingLoan(principalRequested_, collateralRequired_, endingPrincipal_, gracePeriod_, interestRate_, lateFeeRate_, paymentInterval_, paymentsRemaining_);
